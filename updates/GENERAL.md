...
I have an update ready that integrates with this browser api and offers an `Auto Translation` feature for the extensions. I've integrated and tested it on `No Spoilers` extension and am planning a release in some time once I've satisfied with the testing myself.
